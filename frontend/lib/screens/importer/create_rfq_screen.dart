...
class CreateRFQScreen extends ConsumerStatefulWidget {
  ...
  const CreateRFQScreen({super.key, this.duplicateFrom});
...
''');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(_postedReport == null ? 'New RFQ' : 'RFQ Posted')),
      body: SafeArea(
                ...
                children: [
                  ...
                  _SectionCard(
                    ...
                    children: [
                      Row(
                        children: [
                          Expanded(child: TextFormField(controller: _qtyCtrl, keyboardType: TextInputType.number, decoration: const InputDecoration(labelText: 'Quantity'), validator: (v) => (v == null || double.tryParse(v) == null) ? 'Invalid' : null)),
